<template>
    <div class="bg-black text-white px-6 pb-5 pt-20">
        <div class="border border-dashed border-zinc-700 rounded-3xl">
            ...
            <div class="grid grid-cols-3">
                <div class="p-10 relative border-t border-r border-dashed border-zinc-700 mt-20">
                ...
                <div class="p-10 relative border-t border-dashed border-zinc-700 mt-20">
                    <div class="rounded-full w-20 h-20 border border-dashed border-zinc-700 flex justify-center items-center">
                        <div class="rounded-full w-14 h-14 bg-[#1A1A1A] flex justify-center items-center">
                ...
                <div class="p-10 relative border-t border-r border-dashed border-zinc-700">
                    ...
                    <p class="text-[#81807E] text-md">Influenced by global trends, we bring you a diverse and dynamic collection, embodying the spirit of fashion from around the world.</p>
                </div>
                <div class="p-10 relative border-t  border-r border-dashed border-zinc-700">
                    <div class="rounded-full w-20 h-20 border border-dashed border-zinc-700 flex justify-center items-center">
                        <div class="rounded-full w-14 h-14 bg-[#1A1A1A] flex justify-center items-center">
                ...
                <div class="p-10 relative border-t border-dashed border-zinc-700">
                    <div class="rounded-full w-20 h-20 border border-dashed border-zinc-700 flex justify-center items-center">
                        <div class="rounded-full w-14 h-14 bg-[#1A1A1A] flex justify-center items-center">
