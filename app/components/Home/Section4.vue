    ...
    <section class="text-white px-6 pb-5 pt-20 h-full">
        <section class="border-dashed border-zinc-700 border-[5px] rounded-3xl">
            ...
            <section class="ml-10 mt-10 flex flex-wrap gap-5">
                ...
                <button class="w-16 h-10 border-[3px] border-dashed border-zinc-700 rounded-lg">Men</button>
                <button class="w-24 h-10 bg-[#C2B4A3] text-[#0F0F0F] rounded-lg">Women</button>
                <button class="w-16 h-10 border-[3px] border-dashed border-zinc-700 rounded-lg basis-[60%] md:basis-auto">Kids</button>
            </section>
