    ...
    <section class="text-white px-6 pb-5 pt-20 h-full">
        <section class="border-dashed border-[#262626] border-[5px] rounded-3xl">
            ...
            <section class="grid md:grid-cols-2 lg:grid-cols-3">
                <section class="p-4 border-t-[5px] md:border-r-[5px] border-dashed border-[#262626] mt-10 flex items-center flex-col">
                    ...
                    <section class="flex justify-between items-center w-full">
                        ...
                        <NuxtLink to="/products/1" class="bg-[#1F1F1F] p-4 rounded-xl border-[3px] border-dashed border-[#AE9B84]">Shop Now</NuxtLink>
                    </section>
                ...
                <section class="p-4 border-t-[5px] lg:border-r-[5px] border-dashed border-[#262626] md:mt-10 flex items-center flex-col">
                ...
                <section class="p-4 border-t-[5px] md:border-r-[5px] lg:border-r-0 border-dashed border-[#262626] lg:mt-10 flex items-center flex-col">
