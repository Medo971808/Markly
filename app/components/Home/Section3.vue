<template>
    <section class="text-white px-6 pb-5 pt-20 h-full">
        <section class="border-[5px] border-dashed border-zinc-700 rounded-3xl">
            <h1 class="text-3xl lg:text-5xl m-10 uppercase">Navigating the StyleLoom Fashion Journey.</h1>
            ...
            <section class="grid lg:grid-cols-4 md:grid-cols-2">
                ...
                <section class="p-10 border-t-[5px] md:border-r-[5px] border-dashed border-zinc-700 lg:mt-20">
                ...
                <section class="p-10 border-t-[5px] border-dashed border-zinc-700 lg:mt-20">
